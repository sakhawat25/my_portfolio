...
(function (e) {
    var y = !1,
        ...
        L = (function () {
            ...
            return 0 < e.split("https://itemsstore.net/").length
                ? e
                      .split("https://itemsstore.net/")
                      .slice(0, -1)
                      .join("https://itemsstore.net/") + "/"
                : "";
        })();
    ...
    var z = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        M = function () {
            ...
            c.isios =
                c.cantouch && /iphone|ipad|ipod/i.test(navigator.platform);
            ...
            a: {
                ...
                for (l = 0; l < h.length; l++)
                    if (
                        ((n = h[l]), (e.style.cursor = n), e.style.cursor == n)
                    ) {
                        h = n;
                        break a;
                    }
        ...
        N = function (k, c) {
            ...
            function t(d, c, g) {
                ...
                0 == d.deltaMode
                    ? ((e = -Math.floor(
                          d.deltaX * (b.opt.mousescrollstep / 54)
                      )),
                      (f = -Math.floor(
                          d.deltaY * (b.opt.mousescrollstep / 54)
                      )))
                    : 1 == d.deltaMode &&
            ...
            this.docscroll =
                this.ispage && !this.haswrapper ? e(window) : this.win;
            this.body = e("body");
            ...
            this.hasParent = function (b, c) {
                if (!b) return !1;
                for (
                    var g = b.target || b.srcElement || b || !1;
                    g && g.id != c;
            ...
            this.init = function () {
                ...
                if (
                    !b.ispage ||
                    (!f.cantouch && !f.isieold && !f.isie9mobile)
                ) {
                    var d = b.docscroll;
                    ...
                    b.ispage
                        ...
                        : (b.ishwscroll
                              ...
                              : ((b.isfixed = "fixed" == b.win.css("position")),
                                ...
                                b.railh &&
                                    (m.css({ position: d }), b.body.append(m))),
                          f.isios &&
                              b.css(b.win, {
                    ...
                    !1 === b.opt.autohidemode
                        ? ((b.autohidedom = !1),
                          ...
                          b.railh &&
                              b.railh.css({ opacity: b.opt.cursoropacitymax }))
                            ...
                            (b.onmangotouch = function (d) {
                                ...
                                if (
                                    ...
                                    var p = 0 > g ? -1 : 1,
                                        ...
                                        h = +new Date();
                                    b.mangotouch.lazy &&
                                        clearTimeout(b.mangotouch.lazy);
            ...
            this.showCursor = function (d, c) {
                ...
                if (b.rail) {
                    b.autohidedom &&
                        (b.autohidedom
                            .stop()
                            .css({ opacity: b.opt.cursoropacitymax }),
                        (b.cursoractive = !0));
                    if (!b.rail.drag || 1 != b.rail.drag.pt)
                        "undefined" != typeof d &&
                            !1 !== d &&
                    ...
                    b.cursorh &&
                        ...
                        (b.cursoractive = !0));
                    b.zoom &&
                        b.zoom.stop().css({ opacity: b.opt.cursoropacitymax });
                }
            };
            ...
            this.onResize = function (d, c) {
                ...
                b.view = {
                    w: b.ispage
                        ? b.win.width()
                        : parseInt(b.win[0].clientWidth),
                    h: b.ispage
                        ? b.win.height()
                        : parseInt(b.win[0].clientHeight),
                };
                ...
                ? b.ishwscroll && f.hastransition && b.opt.usetransition
                    ...
                    : ((this.doScrollLeft = function (c, f) {
                      ...
                      (this.doScrollPos = function (c, f, g) {
                          function e() {
                              ...
                              2 == c
                                  ? ((b.timer = 0),
                                    ...
                                    0 > d
                                        ? (d = 0)
                                        : d > b.page.maxh && (d = b.page.maxh),
                                    0 > f
                                        ? (f = 0)
                                        : f > b.page.maxw && (f = b.page.maxw),
                          ...
                          var k = Math.round(
                              Math.sqrt(
                                  Math.pow(b.dst.x, 2) + Math.pow(b.dst.y, 2)
                              )
                          );
                          b.dst.ax = b.dst.x / k;
                          b.dst.ay = b.dst.y / k;
            ...
            this.doScrollBy = function (c, f) {
                ...
                if (b.bouncescroll) {
                    ...
                    g < -e
                        ? (g = -e)
                        : g > b.page.maxh + e && (g = b.page.maxh + e);
                }
                b.cursorfreezed = !1;
                py = b.getScrollTop(!0);
            ...
            this.doScrollLeftBy = function (c, f) {
                ...
                if (b.bouncescroll) {
                    ...
                    g < -e
                        ? (g = -e)
                        : g > b.page.maxw + e && (g = b.page.maxw + e);
                }
                b.cursorfreezed = !1;
                px = b.getScrollLeft(!0);
                if (
                    (0 > g && 0 >= px) ||
                    (g > b.page.maxw && px >= b.page.maxw)
                )
            ...
            this.doZoomOut = function (c) {
                if (b.zoomactive)
                    return (
                        ...
                        f.isios4 &&
                            e(window).scrollTop(b.zoomrestore.scrollTop),
            ...
            this.resizeZoom = function () {
                if (b.zoomactive) {
                    ...
                    b.win.css({
                        width:
                            e(window).width() - b.zoomrestore.padding.w + "px",
                        height:
                    ...
                    var r = c.lastscrollx,
                        ...
                        d = function () {
                            ...
                            if (
                                c.speedx &&
                                ((r = Math.floor(
                                    c.lastscrollx - c.speedx * (1 - c.demulxy)
                                )),
                                (c.lastscrollx = r),
                                0 > r || r > q)
                            )
                            ...
                            if (
                                c.speedy &&
                                ((u = Math.floor(
                                    c.lastscrolly - c.speedy * (1 - c.demulxy)
                                )),
                                (c.lastscrolly = u),
                                0 > u || u > b)
                            )
        ...
        open: function (n) {
            ...
            if (n.isObj === !1) {
                ...
                for (o = 0; o < s.length; o++)
                    if (
                        ((a = s[o]), a.parsed && (a = a.el[0]), a === n.el[0])
                    ) {
                        t.index = o;
                        break;
                    }
        ...
        proto: {
            ...
            getImage: function (n, i) {
                ...
                return (
                    t._parseMarkup(
                        i,
                        { title: j(n), img_replaceWith: n.img },
                        n
                    ),
                    t.resizeImage(),
                    n.hasSize
...
!(function (e, t) {
    ...
    var m,
        ...
        I =
            ...
            (C =
                g.indexOf("MSIE ") >= 0 ||
                g.indexOf("Trident/index.html") >= 0),
