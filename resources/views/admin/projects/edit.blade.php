...
@section('content')
    ...
    <nav class="w-full rounded-md">
        <ol class="flex list-none">
            ...
            <li class="text-gray-500">Edit Project</li>
        </ol>
    </nav>
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex h-10">
                    ...
                    <input type="text" name="tags"
                        ...
                        value="{{ $project->tags }}" placeholder="Web Designing, Web Development" />
                </div>
                    ...
                    <div class="flex flex-col items-center pb-10 gap-2">
                        <div class="flex justify-center">
                            <div class="relative w-1/4 project-image-container">
                                <img id='project-image' src="{{ asset('images/' . $project->image) }}" alt="project image"
                                    class="w-full" />
