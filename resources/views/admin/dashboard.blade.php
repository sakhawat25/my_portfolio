...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/admin/img//fav.png') }} " type="image/x-icon" />
...
<body class="bg-gray-100">
    ...
    <div
        ...
        <div class="flex-none w-56 flex flex-row items-center">
            <img src="img/logo02.png" class="w-10 flex-none" />
            <strong class="capitalize ml-1 flex-1">Sakhawat</strong>
                ...
                <div class="dropdown relative md:static">
                    ...
                    <div
                        ...
                        <form method="POST" action="{{ url('logout') }}">
                            @csrf
                            <button type="submit"
                                class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out">Log
                                out</button>
                        </form>
                        <!-- end item -->
                    </div>
                        ...
                        <div class="py-2 ml-10">
                            ...
                            <ul class="mt-4">
                                <li class="text-sm font-light">
                                    <i class="fad fa-check-double mr-2 mb-2"></i> Finish
                                    Dashboard Design
                                </li>
                                <li class="text-sm font-light">
                                ...
                                <li class="text-sm font-light">
                                    <i class="fad fa-check-double mr-2"></i> Publish version
                                    1.0.6
                                </li>
                            </ul>
                        </div>
                ...
                <div class="card-body grid grid-cols-2 gap-6 lg:grid-cols-1">
                    <div class="p-8">
                        ...
                        <div class="mt-20 mb-2 flex items-center">
                            ...
                            <p class="text-black">
                                <span class="num-2 text-green-400"></span><span class="text-green-400">% more
                                    sales</span> in
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="text-black">
                                <span class="num-2 text-red-400"></span><span class="text-red-400">% revenue per
                                    sale</span> in
                                comparison to last month.
                            </p>
                        </div>
