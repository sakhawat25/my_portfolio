...
function erling_tm_modalbox() {
    "use strict";
    jQuery(".erling_tm_all_wrap").prepend(
        '<div class="erling_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
    );
}
...
function erling_tm_modalbox_news() {
    ...
    var button = jQuery(
        ".erling_tm_news .erling_tm_full_link, .erling_tm_news .news_list ul li .title a"
    );
...
function erling_tm_modalbox_portfolio() {
    ...
    button.on("click", function () {
        ...
        modalBox
            ...
            .after(
                '<div class="portfolio_main_title"><h3 class="title">' +
                    title +
...
function erling_tm_my_load() {
    ...
    setTimeout(function () {
        jQuery(".erling_tm_all_wrap").addClass("ready");
    }, speed + 2000);
}
        ...
        var mySwiper = new Swiper(container, {
            ...
            pagination: {
                ...
                renderCustom: function (swiper, current, total) {
                    ...
                    var progressDOM = container.find(
                    ...
                    if (progressDOM.hasClass("fill")) {
                        ...
                        translateX =
                            ((current - 1) * parseInt((100 / total) * 100)) /
                                100 +
                            "px";
                    }
