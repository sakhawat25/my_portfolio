<div class="relative mb-4 flex flex-col">
    <div id="{{ $field }}_error" class="hidden error-message flex items-center text-right text-red-500 text-sm font-medium">
        This is an error
      </div>
    <div class="flex">
        <label
        ...
        <form id="{{ $field }}_form" action="{{ route('admin.profile.updateField', $field) }}"
