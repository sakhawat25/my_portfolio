...
@section('content')
    ...
    <div class="grid grid-cols-2 gap-6 xl:grid-cols-1">
        <div class="w-full px-3 py-4 bg-white border border-gray-300 shadow-md">
            ...
            <div class="flex flex-col items-center pb-10 gap-2">
                <div class="flex justify-center">
                    <div class="relative w-1/4 profile-picture-container">
                        <img id='profile_picture' src="{{ asset('images/' . $user->image) }}" alt="{{ $user->first_name }}"
            ...
            <livewire:InputBox label="Linkedin" type="text" field="linkedin_link" value="{{ $user->linkedin_link }}" />
                    ...
                    <div class="flex flex-col items-center pb-10 gap-2">
                        <div class="flex justify-center">
                            <div class="relative w-1/4 cv-container">
                                <img id='cv-picture'
                                    src="@if ($user->cv_image) {{ asset('images/' . $user->cv_image) }}
                                            @else
                        ...
                        <button id="view-cv-button"
                            ...
                            title="View CV" data-cv-path="{{ asset('files/' . $user->cv) }}"
                            @if ($user->cv == null) disabled @endif>VIEW CV</button>
                    </div>
                </div>
